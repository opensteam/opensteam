...
function transformTable2Grid(id , container) {

	Ext.onReady(function() {
		var grid = new Ext.grid.TableGrid(id, {
			stripeRows: true,
			frame: false,
			width: "auto",
			height:"auto",
		...
		if( $('paging_itemsPerPage' ) ) {
			var converted = new Ext.form.ComboBox({typeAhead: true,triggerAction: 'all',transform:'paging_itemsPerPage',width:58,readOnly: true,forceSelection:true});
		}
	});
