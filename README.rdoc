= opensteam v0.9.5 / v1.0.0 RC2

* http://www.opensteam.net
* http://github.com/shm/opensteam
...
* ShippingRates, Taxes, PaymentTypes
...
* create a new product model (like scaffold):
...
The admin-backend uses the Ext-JS Framework http://extjs.com/ (Grid, Combobox, Tree, Icons). See their License file for more information.
