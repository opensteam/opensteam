...
To learn how to quickly create a webshop with opensteam, you can look at the opensteam rails application-templates at http://github.com/opensteam/opensteam_templates

	rails name_of_rails_app -m http://github.com/opensteam/opensteam_templates/raw/master/opensteam_sample.rb
...
For a list of all required gems and plugins, see the opensteam_sample.rb application template at http://github.com/opensteam/opensteam_templates
...
== LICENSE:
Copyright 2009 (C) DiamondDogs Webconsulting
